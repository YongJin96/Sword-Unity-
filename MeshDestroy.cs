...
public class MeshDestroy : MonoBehaviour
{
    ...
    {
        if (collision.gameObject.layer == LayerMask.NameToLayer("Throw") || collision.gameObject.CompareTag("EnemyAttack"))
        {
            DestroyMesh();
    ...
    private void DestroyMesh()
    {
        ...
        for (var i = 0; i < parts.Count; i++)
        {
            ...
            parts[i].GameObject.layer = 11;

            Destroy(parts[i].GameObject, 5f); // 부셔진 파편들 n초뒤에 삭제
        }
